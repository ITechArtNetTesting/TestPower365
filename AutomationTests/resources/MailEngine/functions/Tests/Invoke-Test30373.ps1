function Invoke-Test30373 {
    ...
    Begin {
        ...
        $FolderName = "Test30373-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30373-" + (Get-Date).ToString("s")
            ...
            $FolderName2 = "Test303732-" + (Get-Date).ToString("s")
        ...
        try {
            ...
            $data = "" | Select Folder
            $data.Folder = ("\Automation\Tests\" + $FolderName + "\" + $FolderName1)
            $Folder = Get-P365PublicFolderFromPath -TargetMailbox -FolderPath $data.Folder
            $Folder.DisplayName = "Renamed12234"
            $Folder.Update()
        ...
        if ($Script:TestResults.ContainsKey("Test30373")) {
            $Script:TestResults["Test30373"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30373", $TestResults)
        }
