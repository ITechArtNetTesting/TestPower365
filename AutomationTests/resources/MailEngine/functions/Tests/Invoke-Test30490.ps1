function Invoke-Test30490 {
    ...
    Begin {
        ...
        $FolderName = "Test30490-" + (Get-Date).ToString("s")
        ...
        #Do the Search  
        $EntryIdVal = $null
        $data = "" | Select Folder1, Folder2, Folder3, MessageId,StartDate,EndDate
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Start = $data.StartDate
            $Appointment.End = $data.EndDate 
        ...
        if ($Script:TestResults.ContainsKey("Test30490")) {
            $Script:TestResults["Test30490"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30490", $TestResults)
        }
