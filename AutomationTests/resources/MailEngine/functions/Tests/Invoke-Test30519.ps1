function Invoke-Test30519 {
    ...
    Begin {
        ...
        $FolderName = "Test30519-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Subject = "Appointment test - 30519 "
        ...
        if ($Script:TestResults.ContainsKey("Test30519")) {
            $Script:TestResults["Test30519"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30519", $TestResults)
        }
