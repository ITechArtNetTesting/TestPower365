function Invoke-Test30075 {
    ...
    Begin {
        ...
        $FolderName = "Test30075-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
			...
			$FolderName1 = "Test30075-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30075")) {
            $Script:TestResults["Test30075"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30075", $TestResults)
        }
