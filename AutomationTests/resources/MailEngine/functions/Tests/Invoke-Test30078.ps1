function Invoke-Test30078 {
    ...
    Begin {
        ...
        $FolderName = "Test30078-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30078-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30078")) {
            $Script:TestResults["Test30078"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30078", $TestResults)
        }
