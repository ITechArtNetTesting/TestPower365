function Invoke-Test30097 {
    ...
    Begin {
        ...
        $FolderName = "Test30097-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30097-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30097")) {
            $Script:TestResults["Test30097"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30097", $TestResults)
        }
