function Invoke-Test30504 {
    ...
    Begin {
        ...
        $FolderName = "Test30504-" + (Get-Date).ToString("s")
        ...
        $TestResults.TestCase = "30504"
        $TestResults.Description = "Appointment Delete Change"
        ...
        if ($Script:TestResults.ContainsKey("Test30504")) {
            $Script:TestResults["Test30504"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30504", $TestResults)
        }
