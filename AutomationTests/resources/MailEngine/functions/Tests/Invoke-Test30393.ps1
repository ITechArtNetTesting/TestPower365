function Invoke-Test30393 {
    ...
    Begin {
        ...
        $FolderName = "Test30393-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            if($Message -ne $null){
                $MovedItem = $Post.Move($NewFolder1.Id)
        ...
        if ($Script:TestResults.ContainsKey("Test30393")) {
            $Script:TestResults["Test30393"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30393", $TestResults)
        }
