function Invoke-Test30479 {
    ...
    Begin {
        ...
        $FolderName = "Test30479-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Task.Subject = "Changed TaskSubject 30478"
            $data.NewSubject = "Changed TaskSubject 30478"
        ...
        $TestResults.TestCase = "30479"
        $TestResults.Description = "Task Delete Check"
        ...
        if ($Script:TestResults.ContainsKey("Test30479")) {
            $Script:TestResults["Test30479"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30479", $TestResults)
        }
