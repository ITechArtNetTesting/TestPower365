function Invoke-Test30477 {
    ...
    Begin {
        ...
        $FolderName = "Test30477-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30477")) {
            $Script:TestResults["Test30477"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30477", $TestResults)
        }
