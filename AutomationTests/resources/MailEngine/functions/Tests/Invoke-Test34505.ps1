function Invoke-Test34505 {
    ...
    Begin {
        ...
        $FolderName = "Test34505-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34505-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test34505")) {
            $Script:TestResults["Test34505"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34505", $TestResults)
        }
