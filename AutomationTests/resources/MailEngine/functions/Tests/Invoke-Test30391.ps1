function Invoke-Test30391 {
    ...
    Begin {
        ...
        $FolderName = "Test30391-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30391")) {
            $Script:TestResults["Test30391"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30391", $TestResults)
        }
