function Invoke-Test34521 {
    ...
    Begin {
        ...
        $FolderName = "Test34521-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34521-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test34521")) {
            $Script:TestResults["Test34521"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34521", $TestResults)
        }
