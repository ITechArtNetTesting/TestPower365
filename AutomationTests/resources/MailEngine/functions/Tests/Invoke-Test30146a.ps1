function Invoke-Test30146a {
    ...
    Begin {
        ...
        $FolderName = "Test30146a-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30146a-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30146a")) {
            $Script:TestResults["Test30146a"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30146a", $TestResults)
        }
