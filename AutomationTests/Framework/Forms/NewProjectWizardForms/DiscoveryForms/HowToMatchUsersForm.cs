...
namespace Product.Framework.Forms.NewProjectWizardForms.DiscoveryForms
{
	...
	{        
		...
		public HowToMatchUsersForm(Guid driverId) : base(TitleLocator, "How to match users form",driverId)
		{
            this.driverId = driverId;
		}

		public HowToMatchUsersForm(By _TitleLocator, string name,Guid driverId) : base(_TitleLocator, name,driverId)
		{
            this.driverId = driverId;
        }
	}
