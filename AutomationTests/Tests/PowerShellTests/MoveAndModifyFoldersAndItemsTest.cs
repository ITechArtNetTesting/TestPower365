...
namespace Product.Tests.PowerShellTests
{
	...
	public class MoveAndModifyFoldersAndItemsTest : LoginAndConfigureTest
	{
		...
		public void Automation_MO_PS_MoveAndModifyFoldersAndItems()
		{
		    ...
		    string stopFile1 = configurator.GetValueByXpath("//metaname[text()='client2']/..//metaname[text()='project1']/..//metaname[text()='stopfile1']/..//path");
		    string stopFile2 = configurator.GetValueByXpath("//metaname[text()='client2']/..//metaname[text()='project1']/..//metaname[text()='stopfile2']/..//path");
