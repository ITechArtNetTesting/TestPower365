	...
	public class DistributionGroupsInitialTest : LoginAndConfigureTest
	{
        ...
        public void Automation_IN_PS_DistributionGroupsInitialTest()
        {
		    ...
		    try
		    {
		        ...
		        User.AtGroupsMigrationForm().WaitForState(group1Name, State.Complete, 1200000, 10);
		        User.AtGroupsMigrationForm().WaitForState(group2Name, State.Complete, 1200000, 10);
		        User.AtGroupsMigrationForm().WaitForState(group3Name, State.Complete, 1200000, 10);
                User.AtGroupsMigrationForm().WaitForState(group4Name, State.Complete, 1200000, 10);
                User.AtGroupsMigrationForm().WaitForState(group5Name, State.Complete, 1200000, 10);
                User.AtGroupsMigrationForm().WaitForState(group6Name, State.Complete, 1200000, 10);
                using (
