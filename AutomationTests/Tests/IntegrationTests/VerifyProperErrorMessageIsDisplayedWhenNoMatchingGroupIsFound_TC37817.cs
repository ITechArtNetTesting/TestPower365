...
{
    [TestClass]
    public class VerifyProperErrorMessageIsDisplayedWhenNoMatchingGroupIsFound_TC37817: LoginAndConfigureTest
    {
        [ClassInitialize]
        ...
        [TestMethod]
        public void VerifyProperErrorMessageIsDisplayedWhenNoMatchingGroupIsFound_37817()
        {
            ...
            var projectName = "IntegrationProjectForTC37817_22";
            ...
            User.AtSelectMigrationGroupForm().SetWrongGroup();
            Assert.IsTrue(User.AtSelectMigrationGroupForm().CheckNoMatchingLable());
            ...
            User.AtSyncAddressBooksForm().SelectFromSourceToTarget();
            User.AtSyncAddressBooksForm().GoNext();
            User.AtSelectMigrationGroupForm().SetWrongGroup();
            Assert.IsTrue(User.AtSelectMigrationGroupForm().CheckNoMatchingLable());
            User.AtSelectMigrationGroupForm().GoBack();
            ...
            User.AtCalendarActiveDirectoryGroupForm().SetWrongGroup();
            Assert.IsTrue(User.AtCalendarActiveDirectoryGroupForm().CheckNoMatchingLable());
