...
namespace Product.Tests.CommonTests.LandingPageTests
{
    ...
    public class ProjectLandingPageShouldHasTenantSection_25771 : LoginAndConfigureTest
    {
        ...
        public void ProjectLandingPageHasTenantStatusSection_MO_25117()
        {
            ProjectLandingPageHasTenantStatusSection(RunConfigurator.GetUserLogin("client1"), RunConfigurator.GetPassword("client1"), RunConfigurator.GetClient("client1"), RunConfigurator.GetProjectName("client1", "project1"));
        }
