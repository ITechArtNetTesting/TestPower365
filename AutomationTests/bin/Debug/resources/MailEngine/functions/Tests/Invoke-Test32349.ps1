function Invoke-Test32349 {
    ...
    Begin {
        ...
        $FolderName = "Test32349-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32349-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test32349")) {
            $Script:TestResults["Test32349"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32349", $TestResults)
        }
