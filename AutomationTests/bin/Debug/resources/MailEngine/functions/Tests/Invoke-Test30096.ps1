function Invoke-Test30096 {
    ...
    Begin {
        ...
        $FolderName = "Test30096-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30096-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30096")) {
            $Script:TestResults["Test30096"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30096", $TestResults)
        }
