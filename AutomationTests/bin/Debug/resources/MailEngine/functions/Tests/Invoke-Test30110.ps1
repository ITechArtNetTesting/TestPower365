function Invoke-Test30110 {
    ...
    Begin {
        ...
        $FolderName = "Test30110-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30110-" + (Get-Date).ToString("s")
            ...
            $FolderName2 = "Test301102-" + (Get-Date).ToString("s")
        ...
        try {
            ...
            $rfRemove.Parameters.Add("Identity", ("\Automation\Tests\" + $FolderName + "\" + $FolderName1));
            $rfRemove.Parameters.Add("Confirm", $false);
            $plPileLine.Commands.Add($rfRemove);
            $RsResultsresults = $plPileLine.Invoke();
            if ($plPileLine.Error.Count > 0) {
        ...
        if ($Script:TestResults.ContainsKey("Test30110")) {
            $Script:TestResults["Test30110"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30110", $TestResults)
        }
