function Invoke-Test30377 {
    ...
    Begin {
        ...
        $FolderName = "Test30377-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30377-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30377")) {
            $Script:TestResults["Test30377"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30377", $TestResults)
        }
