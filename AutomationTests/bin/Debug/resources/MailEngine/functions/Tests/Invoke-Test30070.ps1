function Invoke-Test30070 {
    ...
    Begin {
        ...
        $FolderName = "Test30070-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30070-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30070")) {
            $Script:TestResults["Test30070"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30070", $TestResults)
        }
