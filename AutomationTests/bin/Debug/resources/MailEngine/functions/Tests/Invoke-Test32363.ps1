function Invoke-Test32363 {
    ...
    Begin {
        ...
        $FolderName = "Test32363-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $jnJournal.Subject = "Journal : 32363"
            ...
            $jnJournal.Delete([Microsoft.Exchange.WebServices.Data.DeleteMode]::HardDelete)
        ...
        if ($Script:TestResults.ContainsKey("Test32363")) {
            $Script:TestResults["Test32363"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32363", $TestResults)
        }
