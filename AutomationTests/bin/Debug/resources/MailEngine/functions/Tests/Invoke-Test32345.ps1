function Invoke-Test32345 {
    ...
    Begin {
        ...
        $FolderName = "Test32345-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32345-" + (Get-Date).ToString("s")
            ...
            $Contact.EmailAddresses[[Microsoft.Exchange.WebServices.Data.EmailAddressKey]::EmailAddress1] = "TestAddressFake890@binaryTree.com"
        ...
        if ($Script:TestResults.ContainsKey("Test32345")) {
            $Script:TestResults["Test32345"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32345", $TestResults)
        }
