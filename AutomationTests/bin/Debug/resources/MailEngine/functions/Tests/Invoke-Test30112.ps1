function Invoke-Test30112 {
    ...
    Begin {
        ...
        $FolderName = "Test30112-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30112-" + (Get-Date).ToString("s")
            ...
            $FolderName2 = "Test301122-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30112")) {
            $Script:TestResults["Test30112"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30112", $TestResults)
        }
