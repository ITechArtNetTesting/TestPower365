function Invoke-Test30337 {
    ...
    Begin {
        ...
        $FolderName = "Test30337-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30337-Child" + (Get-Date).ToString("s")
        ...
        $newfp = new-object Microsoft.Exchange.WebServices.Data.FolderPermission($FirstTargetPermission, $PermissiontoAdd)  
        $Folder.Permissions.Clear()
        $Folder.Permissions.Add($newfp)   	    
        $Folder.Update()        
        $TestResults = "" | Select TestCase, Description, TestLastRun, TestResult, Data, ValidationLastRun, ValidationResult, OverAllResult
        $TestResults.TestCase = "30337"
        ...
        if ($Script:TestResults.ContainsKey("Test30337")) {
            $Script:TestResults["Test30337"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30337", $TestResults)
        }
