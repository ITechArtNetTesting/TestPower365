function Invoke-Test32346 {
    ...
    Begin {
        ...
        $FolderName = "Test32346-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32346-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test32346")) {
            $Script:TestResults["Test32346"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32346", $TestResults)
        }
