function Invoke-Test30488 {
    ...
    Begin {
        ...
        $FolderName = "Test30488-" + (Get-Date).ToString("s")
        ...
        #Do the Search  
        $EntryIdVal = $null
        $data = "" | Select Folder1, Folder2, Folder3, MessageId, NewSubject
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Subject = New-Object Microsoft.Exchange.WebServices.Data.ExtendedPropertyDefinition(0x0037, [Microsoft.Exchange.WebServices.Data.MapiPropertyType]::String);            
            $Appointment.SetExtendedProperty($Subject,"New Subject Balh 30488") 
            $data.NewSubject = "New Subject Balh 30488" 
        ...
        if ($Script:TestResults.ContainsKey("Test30488")) {
            $Script:TestResults["Test30488"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30488", $TestResults)
        }
