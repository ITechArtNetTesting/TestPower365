function Invoke-Test30338 {
    ...
    Begin {
        ...
        $TestResults.TestCase = "30338"
        $TestResults.Description = "Public Folder Delete Replace"
        ...
        $FolderName = "Test30338-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30338-" + (Get-Date).ToString("s")
            ...
            $FolderName2 = "Test303382-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30338")) {
            $Script:TestResults["Test30338"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30338", $TestResults)
        }
