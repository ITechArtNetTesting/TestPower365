function Invoke-Test32362 {
    ...
    Begin {
        ...
        $TestResults.TestCase = "32362"
        $TestResults.Description = "Public Folder Journal"
        ...
        $FolderName = "Test32362-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32362-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test32362")) {
            $Script:TestResults["Test32362"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32362", $TestResults)
        }
