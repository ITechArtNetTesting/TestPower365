function Invoke-Test22728{
    param( 
 	...
 	Begin
	 {
		...
		$FolderName = "Test22728-" + (Get-Date).ToString()
		...
		if($Script:TestResults.ContainsKey("Test22728")){
			$Script:TestResults["Test22728"] = $TestResults
		}
		else{
			$Script:TestResults.Add("Test22728",$TestResults)
		}
