function Invoke-Test32341 {
    ...
    Begin {
        ...
        $FolderName = "Test32341-" + (Get-Date).ToString("s")
        $NewFolder.DisplayName = $FolderName
        $NewFolder.FolderClass = "IPF.StickyNote"
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32341-" + (Get-Date).ToString("s")
            ...
            $snStickyNote.Subject = "Stick Note Subject : 32341"  
            ...
            $snStickyNote.Subject = "Stick Note Modified 32341"  
            $snStickyNote.Update([Microsoft.Exchange.WebServices.Data.ConflictResolutionMode]::AlwaysOverwrite)
        ...
        if ($Script:TestResults.ContainsKey("Test32341")) {
            $Script:TestResults["Test32341"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32341", $TestResults)
        }
