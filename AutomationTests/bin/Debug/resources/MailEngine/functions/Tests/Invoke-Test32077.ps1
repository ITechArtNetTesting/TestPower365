function Invoke-Test32077 {
    ...
    Begin {
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32077-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test32077")) {
            $Script:TestResults["Test32077"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32077", $TestResults)
        }
