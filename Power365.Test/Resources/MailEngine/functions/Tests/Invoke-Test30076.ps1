function Invoke-Test30076 {
    ...
    Begin {
        ...
        $FolderName = "Test30076-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30076-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30076")) {
            $Script:TestResults["Test30076"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30076", $TestResults)
        }
