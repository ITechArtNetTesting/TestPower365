function Invoke-Test30489 {
    ...
    Begin {
        ...
        $FolderName = "Test30489-" + (Get-Date).ToString("s")
        ...
        $data.EndDate = (Get-Date).AddDays(9)
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Location = "New Location Balh 30489" 
            $data.Location = "New Location Balh 30489" 
        ...
        $TestResults.TestCase = "30489"
        $TestResults.Description = "Appointment Location Change Check"
        ...
        if ($Script:TestResults.ContainsKey("Test30489")) {
            $Script:TestResults["Test30489"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30489", $TestResults)
        }
