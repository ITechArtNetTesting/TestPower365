...
import-module ($PSScriptRoot + "\..\MailEngine\Engine\btT2TPSModule.psd1") -Force
import-module ($PSScriptRoot + "\..\MailEngine\Engine\btT2TestUtilPSModule.psd1") -Force
...
#TC 22407
$AttachmentPath = $PSScriptRoot + "\..\Attachments\attach.jpg"
