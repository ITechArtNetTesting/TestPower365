function Invoke-Test30470 {
    ...
    Begin {
        ...
        $FolderName = "Test30470-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30470")) {
            $Script:TestResults["Test30470"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30470", $TestResults)
        }
