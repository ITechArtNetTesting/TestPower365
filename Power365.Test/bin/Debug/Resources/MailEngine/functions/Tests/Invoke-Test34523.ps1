function Invoke-Test34523 {
    ...
    Begin {
        ...
        $FolderName = "Test34523-" + (Get-Date).ToString("s")
       ...
       # $NewFolder.FolderClass = "IPF.Task"
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34523-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test34523")) {
            $Script:TestResults["Test34523"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34523", $TestResults)
        }
