function Invoke-Test30522 {
    ...
    Begin {
        ...
        $FolderName = "Test30522-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Subject = "Appointment test - 30522 "
            ...
            $Appointment.RequiredAttendees.Add("Existing-12345@binaryTree.com")  
            ...
            $Appointment.RequiredAttendees.Add("TestFake12345@binaryTree.com")  
        ...
        $TestResults.TestCase = "30522"
        $TestResults.Description = "Meeting RCP Change Check"
        ...
        if ($Script:TestResults.ContainsKey("Test30522")) {
            $Script:TestResults["Test30522"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30522", $TestResults)
        }
