function Invoke-Test32344 {
    ...
    Begin {
        ...
        $FolderName = "Test32344-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32344-" + (Get-Date).ToString("s")
...
#            Invoke-p365CopyPublicFolder -mappingfile $tfile -SourceFolderPath ("\\Automation\tests\" + $FolderName) -TargetCopyPath "\\Automation\tests"
        ...
        if ($Script:TestResults.ContainsKey("Test32344")) {
            $Script:TestResults["Test32344"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32344", $TestResults)
        }
