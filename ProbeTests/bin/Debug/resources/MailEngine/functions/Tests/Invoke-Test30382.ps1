function Invoke-Test30382 {
    ...
    Begin {
        ...
        $FolderName = "Test30382-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30382-" + (Get-Date).ToString("s")
            ...
            for($Im=0;$Im -lt 10;$Im++){
                ...
                $Appointment.Subject = "Test30382-" + (Get-Date).ToString()
                $Appointment.Start = (Get-Date)
                $Appointment.End = (Get-Date).AddHours(1)
                $Appointment.RequiredAttendees.Add("FakeTo@binaryTree.com")
        ...
        if ($Script:TestResults.ContainsKey("Test30382")) {
            $Script:TestResults["Test30382"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30382", $TestResults)
        }
