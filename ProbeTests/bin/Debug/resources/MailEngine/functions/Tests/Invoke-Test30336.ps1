function Invoke-Test30336 {
    ...
    Begin {
        ...
        $FolderName = "Test30336-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30336-Child" + (Get-Date).ToString("s")
        ...
        $newfp = new-object Microsoft.Exchange.WebServices.Data.FolderPermission($Script:TargetMailbox, $PermissiontoAdd)  
        $Folder.Permissions.Clear()
        $Folder.Permissions.Add($newfp)   	    
        $Folder.Update()        
        $TestResults = "" | Select TestCase, Description, TestLastRun, TestResult, Data, ValidationLastRun, ValidationResult, OverAllResult
        $TestResults.TestCase = "30336"
        ...
        if ($Script:TestResults.ContainsKey("Test30336")) {
            $Script:TestResults["Test30336"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30336", $TestResults)
        }
