function Invoke-Test34508 {
    ...
    Begin {
        ...
        $FolderName = "Test34508-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34508-Child" + (Get-Date).ToString("s")
       ...
       # $Folder = Get-P365PublicFolderFromPath -TargetMailbox -FolderPath ("\Automation\tests\" + $FolderName)
        ...
        if ($Script:TestResults.ContainsKey("Test34508")) {
            $Script:TestResults["Test34508"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34508", $TestResults)
        }
