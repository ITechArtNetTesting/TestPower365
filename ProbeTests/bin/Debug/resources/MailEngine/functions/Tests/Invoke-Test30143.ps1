function Invoke-Test30143 {
    ...
    Begin {
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30143-" + (Get-Date).ToString("s")
            ...
            $FolderName2 = "Test301432-" + (Get-Date).ToString("s")
		...
		if(($HasNoteFailed) -band $Okay){
            ...
            $NewFolder2.Delete([Microsoft.Exchange.WebServices.Data.DeleteMode]::HardDelete)
            $NewFolder2 = new-object Microsoft.Exchange.WebServices.Data.Folder($service)  
            $NewFolder2.DisplayName = $FolderName2
            $NewFolder2.FolderClass = "IPF.Note"
            $NewFolder2.Save($NewFolder.Id) 
        ...
        if ($Script:TestResults.ContainsKey("Test30143")) {
            $Script:TestResults["Test30143"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30143", $TestResults)
        }
