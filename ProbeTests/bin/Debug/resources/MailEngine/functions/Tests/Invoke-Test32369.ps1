function Invoke-Test32369 {
    ...
    Begin {
        ...
        $FolderName = "Test32369-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32369-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test32369")) {
            $Script:TestResults["Test32369"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32369", $TestResults)
        }
