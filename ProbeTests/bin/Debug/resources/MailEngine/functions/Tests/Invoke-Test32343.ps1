function Invoke-Test32343 {
    ...
    Begin {
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $snStickyNote.Subject = "Stick Note Subject : 32343"  
            ...
            $snStickyNote.Save($NewFolder.Id)    
            $PR_ENTRYID = new-object Microsoft.Exchange.WebServices.Data.ExtendedPropertyDefinition(0x0FFF,[Microsoft.Exchange.WebServices.Data.MapiPropertyType]::Binary)  
            $psPropertySet = new-object Microsoft.Exchange.WebServices.Data.PropertySet([Microsoft.Exchange.WebServices.Data.BasePropertySet]::FirstClassProperties)  
            $psPropertySet.Add($PR_ENTRYID)
        ...
        if ($Script:TestResults.ContainsKey("Test32343")) {
            $Script:TestResults["Test32343"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32343", $TestResults)
        }
