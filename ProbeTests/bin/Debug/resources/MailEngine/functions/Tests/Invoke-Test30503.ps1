function Invoke-Test30503 {
    ...
    Begin {
        ...
        $FolderName = "Test30503-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Subject = "Appointment test - 30503 "
        ...
        $TestResults.TestCase = "30503"
        $TestResults.Description = "Appointment Rcp Change Check"
        ...
        if ($Script:TestResults.ContainsKey("Test30503")) {
            $Script:TestResults["Test30503"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30503", $TestResults)
        }
