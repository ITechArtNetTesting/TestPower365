function Invoke-Test30079 {
    ...
    Begin {
        ...
        $FolderName = "Test30079-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30079-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30079")) {
            $Script:TestResults["Test30079"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30079", $TestResults)
        }
