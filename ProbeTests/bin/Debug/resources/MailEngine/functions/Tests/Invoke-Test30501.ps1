function Invoke-Test30501 {
    ...
    Begin {
        ...
        $FolderName = "Test30501-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Sensitivity = [Microsoft.Exchange.WebServices.Data.Sensitivity]::Private
        ...
        if ($Script:TestResults.ContainsKey("Test30501")) {
            $Script:TestResults["Test30501"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30501", $TestResults)
        }
