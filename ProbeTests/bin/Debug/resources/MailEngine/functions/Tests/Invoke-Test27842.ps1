function Invoke-Test27842{
    param( 
 	...
 	Begin
	 {
		...
		$FolderName = "Test27842-" + (Get-Date).ToString("s")
		...
		$FolderName1 = "Test27842-Child" + (Get-Date).ToString("s")
		...
		if($Script:TestResults.ContainsKey("Test27842")){
			$Script:TestResults["Test27842"] = $TestResults
		}
		else{
			$Script:TestResults.Add("Test27842",$TestResults)
		}
