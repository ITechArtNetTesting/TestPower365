function Invoke-Test30099 {
    ...
    Begin {
        ...
        $FolderName = "Test30099-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30099-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30099")) {
            $Script:TestResults["Test30099"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30099", $TestResults)
        }
