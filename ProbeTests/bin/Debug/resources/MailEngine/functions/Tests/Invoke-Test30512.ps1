function Invoke-Test30512 {
    ...
    Begin {
        ...
        $FolderName = "Test30512-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $Appointment.Subject = "Appointment test - 30512 "
            ...
            $Appointment.Location = "Appointment Location Modification - 30512"
        ...
        if ($Script:TestResults.ContainsKey("Test30512")) {
            $Script:TestResults["Test30512"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30512", $TestResults)
        }
