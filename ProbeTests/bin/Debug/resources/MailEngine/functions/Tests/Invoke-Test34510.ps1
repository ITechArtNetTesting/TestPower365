function Invoke-Test34510 {
    ...
    Begin {
        ...
        $FolderName = "Test34510-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34510-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test34510")) {
            $Script:TestResults["Test34510"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34510", $TestResults)
        }
