function Invoke-Test34519 {
    ...
    Begin {
        ...
        $FolderName = "Test34519-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34519-Child" + (Get-Date).ToString("s")
       ...
       # $Folder = Get-P365PublicFolderFromPath -TargetMailbox -FolderPath ("\Automation\tests\" + $FolderName)
        ...
        if ($Script:TestResults.ContainsKey("Test34519")) {
            $Script:TestResults["Test34519"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34519", $TestResults)
        }
