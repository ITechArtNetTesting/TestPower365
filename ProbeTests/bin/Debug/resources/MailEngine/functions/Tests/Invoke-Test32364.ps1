function Invoke-Test32364 {
    ...
    Begin {
        ...
        $FolderName = "Test32364-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $jnJournal.Subject = "Journal Modified 32364"  
        ...
        if ($Script:TestResults.ContainsKey("Test32364")) {
            $Script:TestResults["Test32364"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32364", $TestResults)
        }
