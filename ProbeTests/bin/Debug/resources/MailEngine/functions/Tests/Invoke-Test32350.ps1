function Invoke-Test32350 {
    ...
    Begin {
        ...
        $FolderName = "Test32350-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32350-" + (Get-Date).ToString("s")
            ...
            $Contact.Department = "Contact Modified 32350"  
        ...
        if ($Script:TestResults.ContainsKey("Test32350")) {
            $Script:TestResults["Test32350"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32350", $TestResults)
        }
