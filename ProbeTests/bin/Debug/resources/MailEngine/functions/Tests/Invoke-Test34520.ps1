function Invoke-Test34520 {
    ...
    Begin {
        ...
        $FolderName = "Test34520-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34520-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test34520")) {
            $Script:TestResults["Test34520"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34520", $TestResults)
        }
