function Invoke-Test30478 {
    ...
    Begin {
        ...
        $FolderName = "Test30478-" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30478")) {
            $Script:TestResults["Test30478"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30478", $TestResults)
        }
