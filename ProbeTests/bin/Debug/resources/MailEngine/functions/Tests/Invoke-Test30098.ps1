function Invoke-Test30098 {
    ...
    Begin {
        ...
        $FolderName = "Test30098-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test30098-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30098")) {
            $Script:TestResults["Test30098"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30098", $TestResults)
        }
