function Invoke-Test30095 {
    ...
    Begin {
        ...
        $FolderName = "Test30095-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
			...
			$FolderName1 = "Test30095-Child" + (Get-Date).ToString("s")
        ...
        if ($Script:TestResults.ContainsKey("Test30095")) {
            $Script:TestResults["Test30095"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30095", $TestResults)
        }
