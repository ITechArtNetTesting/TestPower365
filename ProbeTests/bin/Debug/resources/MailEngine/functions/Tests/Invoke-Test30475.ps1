function Invoke-Test30475 {
    ...
    Begin {
        ...
        $FolderName = "Test30475-" + (Get-Date).ToString("s")
        ...
        $TestResults.TestCase = "30475"
        $TestResults.Description = "Task Status Check"
        ...
        if ($Script:TestResults.ContainsKey("Test30475")) {
            $Script:TestResults["Test30475"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test30475", $TestResults)
        }
