function Invoke-Test34522 {
    ...
    Begin {
        ...
        $FolderName = "Test34522-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test34522-Child" + (Get-Date).ToString("s")
       ...
       # $Folder = Get-P365PublicFolderFromPath -TargetMailbox -FolderPath ("\" + $RootPath + "\" + $FolderName)
        ...
        if ($Script:TestResults.ContainsKey("Test34522")) {
            $Script:TestResults["Test34522"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test34522", $TestResults)
        }
