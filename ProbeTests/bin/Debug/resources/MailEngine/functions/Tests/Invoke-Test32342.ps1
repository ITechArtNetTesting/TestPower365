function Invoke-Test32342 {
    ...
    Begin {
        ...
        $FolderName = "Test32342-" + (Get-Date).ToString("s")
        ...
        if ($findFolderResults.TotalCount -eq 0) {  
            ...
            $FolderName1 = "Test32342-" + (Get-Date).ToString("s")
            ...
            $snStickyNote.Subject = "Stick Note Subject : 32342"  
            ...
            $snStickyNote.Delete([Microsoft.Exchange.WebServices.Data.DeleteMode]::HardDelete)
        ...
        if ($Script:TestResults.ContainsKey("Test32342")) {
            $Script:TestResults["Test32342"] = $TestResults
        }
        else {
            $Script:TestResults.Add("Test32342", $TestResults)
        }
